...
const newGeneratedQuote = () => {
  let newQuote = `${quote1} ${quote2} ${quote3}`;
  console.log(newQuote);
};

const quoteGenerated = prompt("Do you want to continue:");
//Check if the prompt show us yes
  while (quoteGenerated === "yes"){
    let newQuote = newGeneratedQuote();
    console.log(newQuote);
  }
